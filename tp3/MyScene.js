...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objectComplexity = 0.5; //granularidade
    ...
    initMaterials() {
        ...
        // rgb: 106, 75, 53
        // Wood Material (no ambient, no diffuse, low specular)
        this.material4 = new CGFappearance(this);
        this.material4.setAmbient(100/256, 35/256, 25/256, 1.0); // param 4: alpha, opacidade, transparencia
        this.material4.setDiffuse(45/256, 40/256, 18/256, 1.0);
        this.material4.setSpecular(10/256, 10/256, 10/256, 1.0);
        ...
        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Wood Material': 3, 'Custom': 4 };
    }
    display() {
        ...
        if (this.selectedObject == 5 || this.selectedObject == 6) {
            this.rotate(-Math.PI/2, 1, 0, 0); // coluna vertical
        }
